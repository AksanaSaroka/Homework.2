...
def db_add_new_data():
    ...
    questions = [
        ...
        Question('Он в берлоге спит зимой под большущею сосной, а когда придет весна, просыпается от сна. Кто это?','Медведь','Кот','Волк','Уставший программист'),
        Question('Белая вата поплыла куда-то. Что это?','Облако','Медведь','Белый кот','Йети в бассейне')
    ...
    quizes[4].question.append(questions[9])
    quizes[4].question.append(questions[2])
    quizes[4].question.append(questions[8])
